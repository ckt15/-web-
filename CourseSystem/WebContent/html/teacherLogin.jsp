...
<head>
	...
	<title>精品课程系统--教师登录页面</title>
	<link rel="stylesheet" type="text/css" href="../css/index.css">
</head>
<body>
	<div id="log" style="width: 290px;height: 250px;">
		<span id="tlt" style="font:21px 微软雅黑;">精品课程系统</span><br><br><br>
		<form action="../TeacherLoginServlet" method="post">
			<input type="text" placeholder="请输入账号" class="inp inp1" id="bank" name="tid"><br><br>
			<input type="password" placeholder="请输入密码" class="inp inp2" id="psw" name="tps"><br><br>
			<input type="checkbox" id="saveCookie">
			<span style="font-size: 12px;font-family: 微软雅黑;">记住密码</span>
			<a href="#" class="a1">忘记密码</a><br><br>
